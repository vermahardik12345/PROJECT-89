...
<View style={{flex:8}}>
<KeyboardAvoidingView style={{alignItems:"center",justifyContent:"center"}}>
  <Text style={{fontSize:30,alignSelf:"center",marginTop:240,color:'black'}}>Barter-System</Text>
...
labelStyle={{marginLeft:30,marginTop:50}}
style={styles.textInput2}
keyboardType='email-address'
placeholder="email@address.com"
placeholderTextColor="black"
onChangeText={(text)=>this.setState({emailId:text})}
inputStyle={{marginTop:90,marginLeft:20}}
leftIcon={
  <Icon
  name='envelope'
  size={24}
  color='black'
  style={{marginTop:300,marginLeft:0}}

/>

 }

 inputContainerStyle={{marginLeft:10,marginTop:-300,width:300}}
 inputStyle={{marginLeft:10,marginTop:302}}
/>

<KeyboardAvoidingView>
<Input
label='Password'
labelStyle={{marginLeft:-50,marginTop:20}}
style={styles.textInput2}
secureTextEntry={true}
placeholder="Password"
placeholderTextColor="black"
...
/>
 ...
 inputContainerStyle={{marginLeft:-70,marginTop:-300,width:300}}
 inputStyle={{marginLeft:10,marginTop:302}}
/>
</KeyboardAvoidingView>
...
style={{width:120,height:40,marginLeft:150,marginTop:20}}
